...
// +kubebuilder:rbac:groups=kubeflag.io,resources=challenges,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kubeflag.io,resources=challenges/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=kubeflag.io,resources=challenges/finalizers,verbs=update
